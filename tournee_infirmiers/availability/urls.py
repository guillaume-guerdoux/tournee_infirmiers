...
urlpatterns = [
    url(r'^dashboard/manage_availability$', views.manage_availabilities, name='manage_availability'),
    url(r'^dashboard/create_availability/(\d+)$', views.add_availability, name='add_availability'),
    url(r'^dashboard/choose_nurse$', views.choose_nurse, name='nurse_choice'),
